##################################################
## bifac-GPC model with probit link function    ##
##################################################
...
# Stan Function
stanfit <- stan(file   = 'bifacGPCprobit.stan',
                pars   = param,
                chains = nchains,
                seed   = 7,
                thin   = 1,
...
write.table(results_stan, file="stanfitProbit.csv", sep=";",
...
write.table(crit_values, file="criteriaProbit.csv", sep=";", 
...
# Stan Function
stanfit <- stan(file   = 'bifacGPCprobitrep.stan',
                pars   = param,
                chains = nchains,
                seed   = 7,
                thin   = 1,
...
write.table(pb, file="pvalueProbit.csv", sep=";", 
