##################################################
## bifac-GPC model with clog-log link function  ##
##################################################
...
# Stan Function
stanfit <- stan(file   = 'bifacGPCcloglog.stan',
                pars   = param,
                chains = nchains,
                seed   = 7,
                thin   = 1,
...
write.table(results_stan, file="stanfitCloglog.csv", sep=";",
...
write.table(crit_values, file="criteriaCloglog.csv", sep=";", 
...
# Stan Function
stanfit <- stan(file   = 'bifacGPCcloglogrep.stan',
                pars   = param,
                chains = nchains,
                seed   = 7,
                thin   = 1,
...
write.table(pb, file="pvalueCloglog.csv", sep=";", 
